...
export const TotalRevenue: FC = (): ReactElement => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-12 gap-5 overflow-hidden">
      <div className="md:col-span-8 p-5 overflow-hidden h-[400px] pb-10 bg-white rounded-md shadow-lg shadow-gray-200">
        <h3 className="text-gray-600 font-semibold text-right mb-2">
          کل درآمد
        </h3>
        <TotalRevenueChart />
      </div>
      <div className="md:col-span-4 p-5 flex flex-col items-center justify-center space-y-4 bg-white rounded-md shadow-lg shadow-gray-200">
