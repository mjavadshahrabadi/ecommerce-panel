    ...
    <div className="flex items-center justify-between">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          <button
            type="button"
            className="bg-indigo-500 text-white py-1.5 lg:py-2 px-3 lg:px-5 text-[13px] md:text-[14px] rounded-md hover:shadow-md duration-300 ease-out active:scale-90 transition-all"
          >
            + افزودن کاربر
          </button>
        </div>
